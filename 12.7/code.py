...
if __name__ == "__main__":
    ...
    processPool.apply_async(prumerny_dluh_dle_roku_narozeni,args=(1991,2001,"dvacatniky"))
    processPool.apply_async(prumerny_dluh_dle_roku_narozeni,args=(1981,1991,"tricatniky"))
    processPool.apply_async(prumerny_dluh_dle_roku_narozeni,args=(1971,1981,"ctyricatniky"))
    processPool.apply_async(prumerny_dluh_dle_roku_narozeni,args=(1961,1971,"padesatniky"))
    processPool.apply_async(prumerny_dluh_dle_roku_narozeni,args=(1951,1961,"sedesatniky"))
